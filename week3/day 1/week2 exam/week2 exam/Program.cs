...
public class Program
{
    ...
    public static void Main()
    {
        while (true)
        {
            Console.WriteLine("1 Add nos ");
            Console.WriteLine("2 big ofThree");
            Console.WriteLine("3Square of no");
            Console.WriteLine("4Create and Display Array");
            Console.WriteLine("5Sum of Array Elements");
            Console.WriteLine("6Reverse Array");
            Console.WriteLine("7Find Largest Element");
            Console.WriteLine("8Transpose of Matrix");
            Console.WriteLine("9Exit");
